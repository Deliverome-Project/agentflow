...
<p>Default compensation mode: <strong>{escape(recipe["compensation"]["mode"])}</strong>. Sample-sheet matrix assignments override this default; resolved matrices are in run provenance. <a href='recipe.json'>Recipe JSON</a> · <a href='reproducibility.yaml'>Recipe &amp; provenance YAML</a> · <a href='summary.csv'>Results CSV</a> · <a href='run.json'>Run provenance</a></p>
